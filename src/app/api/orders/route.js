...
export async function GET() {
  try {
    const sql = `SELECT order_id, seller_id, order_date, total_amount, currency, order_status, payment_status, delivery_address, delivery_date, tracking_number, quantity FROM Orders`;
...
export async function POST(request) {
  try {
    const { orderCode, price, quantity, productId, privateCode } =
      await request.json();
